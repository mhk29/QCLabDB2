<?php 
    ...
    if (isset($_POST['upload'])){
        ...
        $special_tags = ["animal","genotype","sex","date","dob","sambabrunno","weight","study","gre","dwi","imagety"];
        ...
        $image_row_in = mysqli_query($db, $sql);
        $image_rows = mysqli_num_rows($image_row_in);

        $sql = "INSERT INTO images (uploader,x_path,y_path,z_path,nifti_path,notes,long_notes,mask_path,image_id) VALUES ('".$uploader."','".$x_path."','".$y_path."','".$z_path."','".$nifti_path."','".$notes."','".$long_notes."','".$label_path."','".$image_rows."');";
        mysqli_query($db, $sql);
    }
?>
...
<body>
    ...
    <div>
        ...
        <?php
            echo "<tr>";
                echo "<td><img src='../images/".$row["x_path"]."''></td>";
                echo "<td><img src='../images/".$row["y_path"]."''></td>";
                echo "<td><img src='../images/".$row["z_path"]."''></td>";
            echo "<tr>";
        ?>
    </div>
    <div>
        ...
        <?php
            ...
            if(isset($row['mask_path'])){
                echo "<div> <a href=".$row['mask_path']."> Label Download </a> </div> ";
            }
        ?>
    </div>
    <div>
